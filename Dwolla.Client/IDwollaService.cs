...
namespace Dwolla.Client
{
    public interface IDwollaService
    {
        ...
        Task<BeneficialOwnerResponse> CreateBeneficialOwnerAsync(Guid customerId, CreateBeneficialOwnerRequest createBeneficialOwnerRequest);
        Task<BeneficialOwnershipResponse> CertifyBeneficialOwnershipAsync(Guid customerId, CertifyBeneficialOwnershipRequest certifyBeneficialOwnershipRequest);
